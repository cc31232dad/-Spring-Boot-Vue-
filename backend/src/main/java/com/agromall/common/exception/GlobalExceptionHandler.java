    ...
    private HttpStatus statusFor(ErrorCode errorCode) {
        return switch (errorCode) {
            case USER_ALREADY_EXISTS, PRODUCT_UNAVAILABLE, INSUFFICIENT_STOCK, INVALID_ORDER_STATUS,
                 ...
                 SECKILL_NOT_PUBLISHABLE, SECKILL_ORDER_FAILED, PRODUCT_REVIEW_INVALID, FARMER_APPLICATION_INVALID -> HttpStatus.CONFLICT;
            case INVALID_CREDENTIALS, UNAUTHORIZED -> HttpStatus.UNAUTHORIZED;
            case FORBIDDEN, FARMER_APPLICATION_PENDING, FARMER_APPLICATION_REJECTED -> HttpStatus.FORBIDDEN;
            case VALIDATION_ERROR, CURRENT_PASSWORD_INVALID -> HttpStatus.BAD_REQUEST;
            case PRODUCT_NOT_FOUND, CATEGORY_NOT_FOUND, CART_ITEM_NOT_FOUND, ORDER_NOT_FOUND,
                 SECKILL_ACTIVITY_NOT_FOUND, ADDRESS_NOT_FOUND, FAVORITE_NOT_FOUND, USER_NOT_FOUND, FARMER_PROFILE_NOT_FOUND -> HttpStatus.NOT_FOUND;
